...
parser.add_option('--userOverride', action='store_true', dest='userOverride', default=False)
...
#	weightDir = '/uscms_data/d3/%s/Substrucure-ROC/analysis/training/weights'%(user);
	weightDir = './weights';
plotDir   = './plots';
...
def condorize(command,tag):
		...
		f1.write("cd /uscms_data/d3/%s/Substrucure-ROC/CMSSW_7_2_0/src/ \n"%(user))
