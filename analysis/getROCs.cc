...
void getROCs() {
    ...
    for(size_t i=0; i<type.size(); i++) {
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_qq-pt5_t_tracks.root", ttype+" vs q tracks 5 TeV",ttype+"_v_all_tracks_ptall");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_ZZ-pt1_t_allpar.root", ttype+" vs Z allpar",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_tt-pt1_t_allpar.root", ttype+" vs t allpar",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_qq-pt1_t_allpar.root", ttype+" vs q allpar", ttype+"_v_all_allpar");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_qq-pt1_t_tragam.root", ttype+" vs q tragam", ttype+"_v_all_tragam");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_ZZ-pt1_t_tracks.root", ttype+" vs Z tracks",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_tt-pt1_t_tracks.root", ttype+" vs t tracks",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt1_qq-pt1_t_tracks.root", ttype+" vs q tracks", ttype+"_v_all_tracks");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_ZZ-pt5_t_allpar.root", ttype+" vs Z allpar 5 TeV", 
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_tt-pt5_t_allpar.root", ttype+" vs t allpar 5 TeV", 
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_qq-pt5_t_allpar.root", ttype+" vs q allpar 5 TeV", ttype+"_v_all_allpar_5");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_ZZ-pt5_t_tragam.root", ttype+" vs Z tragam 5 TeV",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_tt-pt5_t_tragam.root", ttype+" vs t tragam 5 TeV",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_qq-pt5_t_tragam.root", ttype+" vs q tragam 5 TeV", ttype+"_v_all_tragam_5");
        ...
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_ZZ-pt5_t_tracks.root", ttype+" vs Z tracks 5 TeV",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_tt-pt5_t_tracks.root", ttype+" vs t tracks 5 TeV",
        //        "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_qq-pt5_t_tracks.root", ttype+" vs q tracks 5 TeV", ttype+"_v_all_tracks_5");
        ...
        //            "./eosrootfiles/"+plotDir+"/MVA_bdtg_"+ttype+ttype+"-pt5_"+ttype2+ttype2+"-pt5_t_allpar.root", ttype+" vs "+ttype2+" allpar 5 TeV", ttype+"_v_"+ttype2);
